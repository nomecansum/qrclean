...
@section('title')
    <h1 class="page-header text-overflow pad-no">Informe reservas por slot de tiempo</h1>
@endsection
...
@section('breadcrumb')
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">Informe reservas por slot de tiempo</li>
    </ol>
@endsection
@section('content')
@php
...
<div class="card">
	<div class="card-header">
		<h3 class="card-title">Informe de reservas por slot de tiempo</h3>
	...
	<div class="card-body">
		@if (checkPermissions(['Informes'],["R"]))
			<form action="{{url('/reports/reservas_slots/filter')}}" method="POST" class="ajax-filter">
				{{csrf_field()}}
