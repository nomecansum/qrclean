...
@section('cuerpo')
    ...
    <p style="font-size: 14px; line-height: 160%;">{{ $nombre_usuario }} ha cerrado la incidencia <i>[{{ $inc->id_incidencia }}] {{ $inc->des_incidencia!==null?"$inc->des_incidencia":$inc->txt_incidencia  }} </i></p></p>
    <br>
