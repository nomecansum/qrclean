    ...
    <div class="mainnav__inner">
        ...
        <div class="mainnav__top-content scrollable-content pb-5">
            ...
            <ul class="mainnav__menu nav flex-column">
                ...
                <li class="nav-item has-sub ">
                    <a href="#" class="mininav-toggle nav-link mioficina">
                ...
                <ul class="mainnav__menu nav flex-column">
                    ...
                    <li class="nav-item has-sub">
                        ...
                        <ul class="mininav-content nav collapse">
                                ...
                                @if(checkPermissions(['Informes > Puestos por tipo'],['R']))<li class=" nav-item informes"><a href="/reports/puestosxtipo" class="text-nowrap nav-link inf_puestos_tipo"><i class="fa-light fa-file-alt"></i> Puestos por tipo</a></li> @endif
                                ...
                                @if(checkPermissions(['Informes > Reservas slots'],['R']))<li class=" nav-item informes"><a href="/reports/reservas_slots" class="text-nowrap nav-link inf_reservas_slots"><i class="fa-light fa-file-alt"></i> Reservas por slot</a></li> @endif
                                ...
                                @if(checkPermissions(['Informes > Incidencias'],['R']))<li class=" nav-item informes"><a href="/reports/incidencias" class="text-nowrap nav-link inf_incidencias"><i class="fa-light fa-file-alt"></i> Incidencias y solicitudes</a></li> @endif
                ...
                <li class="nav-item has-sub">
                    ...
                    <ul class="mininav-content nav collapse">
                        ...
                        <li class="nav-item has-sub ">
                            ...
                            <ul class="mininav-content nav collapse">
                                @if(checkPermissions(['Avisos'],['R']))<li class=" nav-item"><a href="/avisos" class="text-nowrap nav-link avisos"> <i class="fa-light fa-sign-hanging"></i> Avisos</a></li> @endif
