<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="margin:auto;display:{{ $display??'none' }};" width="50px" height="50px" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid"  id="{{ $id_spin }}" class="{{ $clase }}">
