    ...
    'documentations' => [
        'default' => [
            ...
            'routes' => [
                ...
                */
                'api' => '/ext/docs/api/documentation',
            ],
            'paths' => [
                /*
        ...
        'securityDefinitions' => [
            'securitySchemes' => [
                'passport' => [ // Unique name of security
                    ...
                    'flows' => [
                        "password" => [
                            "authorizationUrl" => config('app.url') . '/api/auth/login',
                            "tokenUrl" => config('app.url') . '/api/auth/login',
                            "refreshUrl" => config('app.url') . '/auth/token/refresh',
                            "scopes" => []
                        ],
                    ],
                ],
