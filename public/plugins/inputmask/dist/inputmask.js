...
! function webpackUniversalModuleDefinition(root, factory) {
    ...
    return modules = [function(module, exports, __webpack_require__) {
            ...
            function ipValidator(chrs, maskset, pos, strict, opts) {
                return chrs = -1 < pos - 1 && "." !== maskset.buffer[pos - 1] ? (chrs = maskset.buffer[pos - 1] + chrs, -1 < pos - 2 && "." !== maskset.buffer[pos - 2] ? maskset.buffer[pos - 2] + chrs : "0" + chrs) : "00" + chrs,
            ...
            module.exports = function maskScope(actionObj, maskset, opts) {
                ...
                function refreshFromBuffer(start, end, buffer) {
                    var i, p;
                    if (!0 === start) resetMaskSet(), maskset.tests = {}, start = 0, end = buffer.length;
                    else
                        ...
                        return $.each(getTests(position), function(ndx, tst) {
                            ...
                            if (getBuffer(!0), rslt = null != test.fn ? test.fn.test(c, maskset, position, strict, opts, isSelection(pos)) : (c === test.def || c === opts.skipOptionalPartCharacter) && "" !== test.def && {
                                ...
                                return elem = elem === opts.skipOptionalPartCharacter && !0 === test.static ? getPlaceholder(position, test, !0) || test.def : elem,
                                    rslt = processCommandObject(rslt), !0 !== rslt && void 0 !== rslt.pos && rslt.pos !== position && (validatedPos = rslt.pos), !0 !== rslt && void 0 === rslt.pos && void 0 === rslt.c ? !1 : (revalidateMask(pos, $.extend({}, tst, {
                        ...
                        if ((void 0 === maxLength || maskPos < maxLength) && (result = _isValid(maskPos, c, strict),
                            ...
                            if (!currentPosValid || !0 !== currentPosValid.match.static || currentPosValid.match.def !== c && c !== opts.skipOptionalPartCharacter) {
                                if (opts.insertMode || void 0 === maskset.validPositions[seekNext(maskPos)] || pos.end > maskPos) {
                                    var skip = !1;
                                    if (maskset.jitOffset[maskPos] && void 0 === maskset.validPositions[seekNext(maskPos)] && (result = isValid(maskPos + maskset.jitOffset[maskPos], c, !0), !1 !== result && (!0 !== fromAlternate && (result.caret = maskPos), skip = !0)),
                                        pos.end > maskPos && (maskset.validPositions[maskPos] = void 0), !skip && !isMask(maskPos, !0))
                    ...
                    EventHandlers = {
                        keydownEvent: function keydownEvent(e, fromInputFallback) {
                            ...
                            if (k === Inputmask.keyCode.BACKSPACE || k === Inputmask.keyCode.DELETE || iphone && k === Inputmask.keyCode.BACKSPACE_SAFARI || e.ctrlKey && k === Inputmask.keyCode.X && !isInputEventSupported("cut")) e.preventDefault(),
                                handleRemove(input, k, pos), writeBuffer(input, getBuffer(!0), !0 === fromInputFallback && !1 === opts.insertMode ? seekPrevious(maskset.p) : maskset.p, e, input.inputmask._valueGet() !== getBuffer().join(""));
                        ...
                        keypressEvent: function keypressEvent(e, checkval, writeOut, strict, ndx) {
                            ...
                            if (k) {
                                ...
                                if (!1 !== valResult && (resetMaskSet(!0), forwardPosition = void 0 !== valResult.caret ? valResult.caret : seekNext(valResult.pos.begin ? valResult.pos.begin : valResult.pos),
                                        maskset.p = forwardPosition), forwardPosition = opts.numericInput && void 0 === valResult.caret ? seekPrevious(forwardPosition) : forwardPosition, !1 !== writeOut && (setTimeout(function() {
                        ...
                        focusEvent: function focusEvent(e) {
                            ...
                            opts.showMaskOnFocus && nptValue !== getBuffer().join("") && writeBuffer(this, getBuffer(), seekNext(getLastValidPosition())), !0 !== opts.positionCaretOnTab || !1 !== mouseEnter || isComplete(getBuffer()) && -1 !== getLastValidPosition() || EventHandlers.clickEvent.apply(this, [e, !0]),
                    ...
                    if ($.each(inputValue, function(ndx, charCode) {
                        ...
                        if (!isComplete(getBuffer()) || staticMatches.length < seekNext(0))
                            for (; void 0 !== (sndx = staticMatches.pop());) {
                                ...
                                for (; sndx = staticMatches.pop();) validPos = maskset.validPositions[sndx],
                ...
                function handleRemove(input, k, pos, strict, fromIsValid) {
                    ...
                    if (lvp < pos.begin || -1 === pos.begin) maskset.p = seekNext(lvp);
                    else if (!0 !== strict && (maskset.p = pos.begin, !0 !== fromIsValid))
                        for (; maskset.p < lvp && void 0 === maskset.validPositions[maskset.p];) maskset.p++;
                }
                        ...
                        if (void 0 === caretPos ? caretPos = caret(input) : void 0 === caretPos.begin && (caretPos = {
                            ...
                            do {
                                if (maskset.validPositions[pos]) testPos = maskset.validPositions[pos], test = testPos.match,
                                    ndxIntlzr = testPos.locator.slice(), setEntry(buffer[pos]);
                                else {
                                    testPos = getTestTemplate(pos, ndxIntlzr, pos - 1), test = testPos.match, ndxIntlzr = testPos.locator.slice();
                ...
                function mask(elem) {
                    ...
                    if (!1 !== isSupported && (el = elem, $el = $(el), originalPlaceholder = el.placeholder,
                            maxLength = void 0 !== el ? el.maxLength : void 0, -1 === maxLength && (maxLength = void 0), !0 === opts.colorMask && initializeColorMask(el), mobile && ("inputmode" in el && (el.inputmode = opts.inputmode,
                                ...
                                EventRuler.on(el, "blur", EventHandlers.blurEvent), EventRuler.on(el, "focus", EventHandlers.focusEvent), !0 !== opts.colorMask && (EventRuler.on(el, "click", EventHandlers.clickEvent),
