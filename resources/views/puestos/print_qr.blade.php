...
@section('content')
    <div class="row" style="background-color: #fff" id="printarea">
        @foreach($puestos as $puesto)
            <div class="float-left pb-4 pr-4 mr-0 ml-0" style="width: 240px; display: inline-block; border: 1px solid #ccc;">
                <div class="mb-0 pb-0">
                    <img src="data:image/png;base64, {!! base64_encode(QrCode::format('png')->size(230)->generate(config('app.url_base_scan').$puesto->token)) !!} ">
