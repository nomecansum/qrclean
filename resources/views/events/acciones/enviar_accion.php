...
$descripcion="Envia una accion al dispositivo indicado";

$campos_notificaciones=false;

$icono='<i class="fa-solid fa-arrow-up-right-from-square"></i>';

$params='{
    "parametros":[
        {
            "label": "Accion a enviar",
            "name": "id_accion",
            "tipo": "list_db",
            "multiple": false,
            "sql": "select id_accion as id, concat(des_accion,\' [\',abr_accion,\']\') as nombre from acciones order by id_tipo_accion,des_accion",
            "required": true,
            "buscar": true
        },
        {
            "label": "Parametros de la accion",
            "name": "parametros",
            "tipo": "txt",
            "def": "",
            "required": false
...
$func_accion = function($accion, $resultado, $campos, $id) {
    ...
    $param = valor($param_accion, "parametros");
