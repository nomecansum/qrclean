    ...
    static setStatus(toastEl, status) {
        ...
        switch (status) {
            case TOAST_STATUS.SUCCESS:
                statusIcon.classList.add("text-success", "fa-solid", "fa-circle-check");
                break;
            case TOAST_STATUS.DANGER:
                statusIcon.classList.add("text-danger", "fa-solid", "fa-circle-xmark");
                toastEl.setAttribute("role", "alert");
                toastEl.setAttribute("aria-live", "assertive");
                break;
            case TOAST_STATUS.WARNING:
                statusIcon.classList.add("text-warning", "fa-solid", "fa-circle-exclamation");
                toastEl.setAttribute("role", "alert");
                toastEl.setAttribute("aria-live", "assertive");
                break;
            case TOAST_STATUS.INFO:
                statusIcon.classList.add("text-info", "fa-solid", "fa-circle-info");
                break;
            default:
