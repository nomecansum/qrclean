                        ...
                        <tr>
                            <td align="left" style="padding:0;Margin:0">
                                <p
                                    ...
                                    {{ $titulo_email??'' }}
                                    {{-- AQUI IRIA EL TITULO DE LA NOTIFICACION QUE QUEREMOS HACER --}
                                    {{-- Asignacion de puesto</p> --}}
                                </p>
                            </td>
                        </tr>
                    </table>
                        ...
                        <tr>
                            <td style="padding:0;Margin:0;font-size:0px"
                                align="center"><img class="adapt-img"
                                    src="https://crambo.eu/newsletters/plantillas_reservas/{{ $triangulo??'alerta_05' }}.png"
                                    alt
                                    style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic"
                                    width="127"></td>
                        </tr>
