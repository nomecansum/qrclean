...
@section('titulo')
    ...
    <span style="padding-top: 30px; font-weight: bold">Se ha reabierto una incidencia</span></span></p>
@endsection

@section('cuerpo')
    <p style="font-size: 14px; line-height: 160%;"> </p>
    <p style="font-size: 14px; line-height: 160%;">Se ha reabierto incidencia de tipo <span style="color:#6488C0"><strong>{{ $tipo->des_tipo_incidencia }}</strong>:</span></p></p>
    <br>
