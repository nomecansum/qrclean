...
@elseif(isset($asignado_usuario))<br>
    <div  style="font-size: {{ $puesto->factor_letra+0.8 }}vw; color: {{ isset($es_reserva) && $es_reserva?"#fff":"#f4d35d" }}; line-height: 0px; margin-top: 0.4em">{{ iniciales($asignado_usuario->name,3) }}</div>
