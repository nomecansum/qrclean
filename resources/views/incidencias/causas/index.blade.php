...
@section('breadcrumb')
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">causas de cierre</li>
                        ...
                        <tr class="hover-this">
                            ...
                            <td>
                                <div class="pull-right floating-like-gmail mt-2" role="group">
                                    ...
                                    <a href="#eliminar-planta-{{$tipo->id_causa_cierre}}" data-target="#eliminar-planta-{{$tipo->id_causa_cierre}}" title="Borrar tipo" data-toggle="modal" class="btn btn-xs btn-danger add-tooltip btn_del"><span class="fa fa-trash" aria-hidden="true"></span> Del </a>
                                </div>
