...
if (! function_exists('lista_clientes')) {
...
if (! function_exists('decodeComplexJson')) {
...
if (! function_exists('mensaje_excepcion')) {
...
if (! function_exists('isCustomerAdmin')) {
...
if (! function_exists('formatmysqldate2')) {
    function formatmysqldate2($date){
        return Carbon::createFromFormat('d/m/Y', $date)->format('Y-m-d');
    }
}

if (! function_exists('formatspdate')) {
...
if (! function_exists('adaptar_fecha')) {
...
if (! function_exists('random_readable_pwd')) {
...
if (! function_exists('comodines_texto')) {
...
if (! function_exists('icono_nombre')) {
...
if (! function_exists('imagen_usuario')) {
...
if (! function_exists('color_porcentaje_inv')) {
